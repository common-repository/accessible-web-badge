 ...
 * Admin API class.
 */
class Aweb_Badge_Plugin_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'aweb-badge-plugin' ) . '" data-uploader_button_text="' . __( 'Use image', 'aweb-badge-plugin' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'aweb-badge-plugin' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'aweb-badge-plugin' ) . '" />' . "\n";
	...
	public function validate_field( $data = '', $type = 'text' ) {
		...
		switch ( $type ) {
			case 'url':
				...
				break;
			case 'email':
				$data = sanitize_email( is_email( $data ) );
				break;
		}
